...
int main()
{
	...
	do
	{
		...
		case 4:
			...
			{
			case 1: {
				queue_public q_public(q_base);
				cout << "Колличество элементов, больших, чем среднее арифметическое:" << q_public.task() << endl;
				break;
			}
			case 2: {
				queue_protected q_protected(q_base);
				cout << "Колличество элементов, больших, чем среднее арифметическое:" << q_protected.task_protected() << endl;
				break;
			}
			case 3: {
				queue_private q_private(q_base);
				cout << "Колличество элементов, больших, чем среднее арифметическое:" << q_private.task_private() << endl;
				break;
			}
			default:
